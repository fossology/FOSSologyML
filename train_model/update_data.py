...
file_type: needed for successful comment extraction
...
from rigel.pipeline.enums import Tag
...
def update_document(document: Documents.File):
    try:
        ...
        license_related_words = preprocessor.process(file_content, file_type)
        no_license_related_wors = preprocessor.process_no_license_relevant_words(file_content, file_type)
